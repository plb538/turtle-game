...
public class EnemyLevel1 extends GameState{
		
	private MonkeyEnemy m1;
	private MonkeyEnemy m2;
	
	public EnemyLevel1(GameStateManager gsm){
		this.gsm = gsm;
		init();
	}
	...
	public void init(){
		...
		tileMap.loadMap("/Maps/Enemy1.map");
		...
		portal.setPosition(tileMap.getWidth()-96*2, 100);
