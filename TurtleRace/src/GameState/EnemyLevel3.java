...
public class EnemyLevel3 extends GameState{
		
	private MonkeyEnemy m1;
	private MonkeyEnemy m2;
	
	public EnemyLevel3(GameStateManager gsm){
		this.gsm = gsm;
		init();
	}
	...
	public void init(){
		...
		tileMap.loadMap("/Maps/Enemy3.map");
		...
		portal.setPosition(tileMap.getWidth()-100, 150);
